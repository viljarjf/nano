...
\subsection{Electric dipoles}
    ...
    If we define a coordinate system such that $\vec{p}$ lies on the $z$-axis, with the centre of the dipole at the origin, then this can be further simplified to
    \begin{equation}
...
\subsection{Current}
    ...
    \subsubsection{Charging and discarging}
        If an ideal (internal resistance $r=0$) voltage source $\Epsilon$ is coupled in series with a resistor $R$ 
