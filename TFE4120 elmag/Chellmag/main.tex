...
\section{Main formulas}
    \begin{center}
        \begin{tabular}{c|c}
            \hline
            \rowcolor{gray!25} Maxwell's, differential form & \\
            \hline
            ...
            \hline
            \rowcolor{gray!25} Maxwell's, integral form & \\
            \hline
                    \rule[-3ex]{0pt}{0pt}\rule{0pt}{4ex}
            ...
            \hline
            \rowcolor{gray!25} Coulomb field & \\
            \hline
                \rule[-3ex]{0pt}{0pt}\rule{0pt}{4ex}
                $\displaystyle\E(r, \phi, \theta) = \frac{q}{4\pi\e r^2}\hat{r}$ & \\
            \hline
            \rowcolor{gray!25} Laplace's elementary laws & \\
            \hline
                    ...
                    $ \\
            \hline
            \rowcolor{gray!25} Energy density & \\
            \hline
            \rule[-3ex]{0pt}{0pt}\rule{0pt}{4ex}
