...
\section{Magnetostatics}
    ...
    \subsection{Currents as magnetic field sources}
        ...
        $\mu_0 = 1.257\cdot 10^{-6}$\si{\henry\per\metre}(redefined in 2019, no longer \textit{defined} as $4\pi\cdot10^{-7}$ but still very close) is the \textit{magnetic permeability}. 
...
\section{Time-variant fields}
    ...
    \subsection{Electromagnetic waves}
        \subsubsection{Magnetic vector potential}
            ...
            \end{align*}
            where $S:\, \mathbb{R}^4 \rightarrow \mathbb{R}$ is a scalar function with both a spatial- and a time-parameter.
        ...
        \subsubsection{Arriving at the wave equation}
            ...
            \begin{center}
                \begin{tabular}{ c|c }
                    $\square V = 0$&$ \square\,\E = 0$\\
                    $\square\,\vec{A} = 0 $&$\square\,\B = 0$
                \end{tabular}
            \end{center}
