...
\section{Magnetostatics}
    ...
    \subsection{Real magnetic materials}
        \subsubsection{Paramagnetic materials}
            ...
            $\left<p\right>=0$ if $\B_ext = 0$. Else, 
            \begin{equation}
                \vec{M} = \chi_m\H,
            \end{equation}
        ...
        \subsubsection{Diamagnetic materials}
            Examples: $\text{H}_2$, $\text{N}_2$, Na, Cu, Hg. 
            ...
            \begin{equation}
                \vec{M} = \chi_m\H,
            \end{equation}
            where the magnetic suceptability $\chi_m$ ranges from around $10^{-9}$ to $10^{-5}$. For diamagnetic materials, $\chi_m < 0$ and $\vec{M}$ is antiparallel to \H.
