...
\subsection{Electric dipoles}
    ...
    (The derivation for the final expression is different from just using the nabla operator on the potential, but I included it here since the result is the same.)
